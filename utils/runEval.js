...
// console.log(process.env.COMPLETION_API_TOKEN)
// console.log(process.env.model)
// console.log("complet", process.env.COMPLETION_API_MODEL)
// console.log(process.env.COMPLETION_API_PATH)
...
export default function runEval(promptsForEval) {
